...
class CRM_Report_Form_Contribute_Commission extends CRM_Report_Form {
...
";
  ...
  function alterDisplay(&$rows) {
    ...
    foreach ($rows as $rowNum => $row) {
      ...
      if (array_key_exists('civicrm_value_contribution_data_3_worker_select_50', $row) && CRM_Utils_Array::value('civicrm_value_contribution_data_3_worker_select_50', $rows[$rowNum])) {
        $url = CRM_Utils_System::url("civicrm/report/instance/26", 'force=1&worker=' . $row['civicrm_value_contribution_data_3_worker_select_50'] . $startClause . $endClause, $this->_absoluteUrl);
        $rows[$rowNum]['civicrm_value_contribution_data_3_worker_select_50_link'] = $url;
        $rows[$rowNum]['civicrm_value_contribution_data_3_worker_select_50_hover'] = ts("View details for this Worker.");
      }
