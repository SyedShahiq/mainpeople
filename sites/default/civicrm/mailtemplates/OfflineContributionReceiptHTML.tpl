...
<center>
  <table width="620" border="0" cellpadding="0" cellspacing="0" id="crm-event_receipt" style="font-family: Arial, Verdana, sans-serif; text-align: left;">
    ...
    {assign var=contdata value="Contribution Data"}
    {assign var=doneeorg value="Donee Organization"}
    {if $customGroup.$contdata.$doneeorg eq 'MPA'}
      <!-- BEGIN MPA HEADER -->
      <tr><td>
          <table style="margin: 0pt auto; width: 700px; background-color: rgb(153, 153, 204);" border="0" cellpadding="10" cellspacing="0">
            <tbody>
            <tr>
      ...
      <!-- END HEADER -->
    {elseif $customGroup.$contdata.$doneeorg eq 'MPRC'}
      <!-- BEGIN MPRC HEADER -->
      <tr><td>
          <table style="margin: 0pt auto; width: 700px; background-color: rgb(153, 153, 204);" border="0" cellpadding="10" cellspacing="0">
            <tbody>
            <tr>
              <td style="font-family: tahoma,arial,helvetica,sans-serif; background-color: rgb(153, 153, 204); width: 150px;">
                <img src="http://www.mainepeoplesresourcecenter.org/images/logomprc.jpg" style="float: left; margin: 5px;" height="160" width="165">
    ...
    <tr>
      <td>
        ...
        {else}
          <p>{ts}Thank you very much for your support. We couldn't do the work we do without people like you behind us.{/ts}</p>
        {/if}

        <p>{ts}Please print this receipt for your records.{/ts}</p>
        <p>{ts}Because MPA engages in lobbying of our legislature, donations are not tax deductible. Donations to MPA's sister organization, Maine People's Resource center are tax deductible.{/ts}</p>
