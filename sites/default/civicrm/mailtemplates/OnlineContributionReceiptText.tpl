...
{if $is_pay_later}
  ...
  ===========================================================
{else}
  {ts}Thank you very much for your support. We couldn't do the work we do without people like you behind us.{/ts}
{/if}

  {ts}Please print this receipt for your records.{/ts}
  {ts}Because MPA engages in lobbying of our legislature, donations are not tax deductible.{/ts}
